...
const (
	...
	EntityGenericID         EntityType = "GENERIC_ID"
...
type PreviewResult struct {
	// Anonymized is the final text after applying enabled replacements.
	Anonymized string `json:"anonymized_text"`
	// Result is embedded so preview reuses the same findings and stats payload.
	Result
}
